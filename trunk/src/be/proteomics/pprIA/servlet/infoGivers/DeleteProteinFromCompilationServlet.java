 ...
 */
public class DeleteProteinFromCompilationServlet  extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        int sessionNumber = -1;
            ...
            int proteinsfound = searches.getProteinCount(sessionNumber);
        //if(proteinsfound > 1){
            searches.deleteProteinFromResult(sessionNumber, protein);
        //}
