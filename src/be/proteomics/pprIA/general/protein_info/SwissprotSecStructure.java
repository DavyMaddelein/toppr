...
import be.proteomics.ppr.general.proteinInfo.das.StartEndPosition;
import be.proteomics.pprIA.general.protein_info.das.DasAnnotationServerResultReader;
import be.proteomics.pprIA.general.protein_info.das.DasFeature;
 ...
 */
public class SwissprotSecStructure {
    private String iUrl;
    ...
    public SwissprotSecStructure(String protein, String aSequence){
