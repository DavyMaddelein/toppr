...
public class DasFeature {
    ...
    public DasFeature(String aFeature){
        ...
        if (iFeature.indexOf("<TYPE") != -1 && iFeature.indexOf("</TYPE") == -1){
            this.type = "no type";
        }
        else {
        ...
        if(iFeature.indexOf("<START") != -1)
        {
            this.start = new Integer(iFeature.substring(iFeature.indexOf(">",iFeature.indexOf("<START")) + 1,iFeature.indexOf("</START")));
        }else{
            this.start = -1;
        }
        if (iFeature.indexOf("<END") != -1){
        this.end = new Integer(iFeature.substring(iFeature.indexOf(">",iFeature.indexOf("<END")) + 1,iFeature.indexOf("</END")));
        }
        else{
            this.end = -2;
        }
    ...
    public String toString(){
        ...
        result = result + "\nTypeid: " + typeId + " type catagory: " + typeCategory + " type reference: " + typeReference+ " type subparts: " + typeSubparts + " type superparts: " + typeSuperparts + " type: " + type;
